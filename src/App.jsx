        ...
        <div key={booking._id} style={{ background:T.surface, border:`1px solid ${T.border}`, borderRadius:20, overflow:"hidden" }}>
          ...
          <div style={{ padding:"18px 20px" }}>
            ...
            {confirming===booking._id ? (
              ...
              <button onClick={()=>setConfirming(booking._id)} style={{ width:"100%", padding:"11px 0", borderRadius:10, border:"none", background:`linear-gradient(135deg,${T.accent},#ff8c55)`, color:"#fff", fontWeight:700, fontSize:13, cursor:"pointer" }}>
                🔐 Confirm Delivery (Enter Code)
              </button>
            )}
          </div>
        </div>
